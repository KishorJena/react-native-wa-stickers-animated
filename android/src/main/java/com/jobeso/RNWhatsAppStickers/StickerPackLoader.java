...
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.ANIMATED_STICKER_PACK;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.AVOID_CACHE;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.IMAGE_DATA_VERSION;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.PUBLISHER_EMAIL;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.PUBLISHER_WEBSITE;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
// import static com.jobeso.RNWhatsAppStickers.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
// class StickerPackLoader {



//     // public static final String CONTENT_PROVIDER_AUTHORITY = RNWhatsAppStickersModule.getContentProviderAuthority(getContext());
//     public static final String CONTENT_PROVIDER_AUTHORITY = "com.jobeso.RNWhatsAppSticker" + ".stickercontentprovider";
...
//     // public static final String authority = RNWhatsAppStickersModule.getContentProviderAuthority(getContext());
//     // public static final Uri AUTHORITY_URI = new Uri(authority);

//     @NonNull
//     static ArrayList<StickerPack> fetchStickerPacks(Context context) throws IllegalStateException {
//         String authority = RNWhatsAppStickersModule.getContentProviderAuthority(context);
//         // String authority = context.getPackageName() + ".stickercontentprovider";
//         // android.net.Uri uri = android.net.Uri.parse(authority);
//         // final Uri Uri1 = new Uri("content://" + authority + "/" + StickerContentProvider.METADATA);
//         // final Uri Uri1 = new Uri.parse(uri.toASCIIString());
//         // final Uri queryUri = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT)
//         // .authority(authority);
//         Uri AUTH  = Uri.parse(authority);

//         // add columns projection etc
//         final Uri queryUri = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT)
//                 .authority(authority)
...
//         return new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority(CONTENT_PROVIDER_AUTHORITY).appendPath(StickerContentProvider.STICKERS).appendPath(identifier).build();
//     }

//     static Uri getStickerAssetUri(String identifier, String stickerName) {
//         return new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority(CONTENT_PROVIDER_AUTHORITY).appendPath(StickerContentProvider.STICKERS_ASSET).appendPath(identifier).appendPath(stickerName).build();
//     }
// }